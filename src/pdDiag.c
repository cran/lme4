...
SEXP
pdDiag_coefGets(SEXP x, const SEXPREC* value)
{
...
SEXP
pdDiag_LMEgradient(const SEXPREC* x, const SEXPREC* Ain,
		const SEXPREC* nlev)
{
...
SEXP pdDiag_EMupdate(SEXP x, const SEXPREC* nlev, const SEXPREC* Ain)
{
    int nlevVal = asInteger((SEXP)nlev);
    SEXP param = GET_SLOT(x, install("param"));
